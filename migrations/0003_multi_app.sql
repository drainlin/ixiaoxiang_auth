ALTER TABLE sessions ADD COLUMN app_id TEXT NOT NULL DEFAULT 'cinedock';
...
ALTER TABLE library_profiles ADD COLUMN app_id TEXT NOT NULL DEFAULT 'cinedock';
...
CREATE TABLE user_settings (
  ...
  app_id TEXT NOT NULL DEFAULT 'cinedock',
...
SELECT user_id, 'cinedock', payload_json, updated_at
